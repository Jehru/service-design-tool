 ...
 * Usage: use the left sidebar to manage layers (add/rename/delete/toggle visibility). Select a layer, then use "Add node" in the top toolbar to create sticky notes on that layer. Drag nodes to reposition them on the canvas. Toggle "Connect mode" to click two nodes and create a connection line. Pan the canvas by dragging empty space; zoom with Ctrl + mouse wheel if needed.
 */
